...
class UserActivitiesView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: BlocSelector<UserActivitiesBloc, UserActivitiesState, bool>(
        selector: (state) {
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Text(
                          "Connect, stay safe and watch each others back."),
                      const SizedBox(height: 12.0),
                      Row(
                        ...
                        children: [
                          ...
                          ActionTag(
                            ...
                            onPressed: () =>
                                context.pushNamed(MembersPage.route),
                          ),
                          ActionTag(
                            text: "Who tagged me?",
                            icon: Icons.people,
